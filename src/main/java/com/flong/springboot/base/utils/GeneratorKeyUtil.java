...
public class GeneratorKeyUtil {
    ...
    private static GeneratorKeyUtil snowFlake = null;

    static{
        snowFlake = new GeneratorKeyUtil();
    }
    public static synchronized long nextId(){
        return snowFlake.getNextId();
    }

    private GeneratorKeyUtil() {
    ...
    public static String getCustNextId () {
        return "KH" + nextId();
    }
    ...
    public static String getOutOrderNextCode () {
        return "CKD" + nextId();
    }
